...
#define BUTTON_RED    9
#define BUTTON_GREEN  0 // ORIGINAL D2 CQAMBIADO A D0
#define BUTTON_BLUE   12
#define BUTTON_YELLOW 11 // ORIGINAL D6 CQAMBIADO A D11

// Buzzer pin definitions
#define BUZZER1  8  // ORIGINAL D4 CQAMBIADO A D8
#define BUZZER2  7  
#define BOOM A0

// Define game parameters
#define ROUNDS_TO_WIN      7 //Number of rounds to succesfully remember before you win. 13 is do-able.
#define ROUNDS_TO_BLOW     6 // Número de rondas para explotar
...
#define NUM_LEDS 15  //Total Number of LED
#define DATA_PIN 2   //Cyclone LED Strip D2 (MODIFICADO A D0)
#define SCORE_PIN 6  //Level LED Strip D6 (MODIFICADO A D8)
#define SCORE_LEDS 4
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  pinMode(4, INPUT_PULLUP);                                           //Push Button D4 (MODIFICADO A D11)
  Serial.begin(9600);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //digitalWrite(1, LOW);
  if((checkButton() != CHOICE_NONE) && (att < 6) && (!simon))
    simonSays();
  
  if(att == ROUNDS_TO_BLOW) {
    analogWrite(BOOM, 255);
    
    while(att < (ROUNDS_TO_BLOW+5)) {
      buzz_sound(300, NOTE_A6);
      buzz_sound(150, NOTE_E3);
      delay(500);
      att++;
    }
  }
  ...
  //if((digitalRead(4) == LOW)&&(!arc)){
    ...
    if (gameState == 1) {
     ...
     if (millis() > time_now + period) {
       time_now = millis();
        if (findRandom) {
         spot = random(11) + 3;              //Total Cyclone LED - 4
          findRandom = false;
        }
...
//      period = 320;
  ...
  //}
    //if(digitalRead(4) == LOW){
      //buzz_sound(200, NOTE_G6);
      //buzz_sound(200, NOTE_B6);
      //delay(500);      
      //arcade();
    //}*/
  //}
...
void arcade() {
  while(checkButton() == CHOICE_NONE){
    if (gameState == 0) {
      fill_rainbow(leds, NUM_LEDS, 0, 15); //2 = longer gradient strip
      fill_rainbow(sleds, SCORE_LEDS, 0, 7); //2 = longer gradient strip
      if (digitalRead(11) == LOW) { // PIN D4 ORIGINALMENTE, CAMBIADO A D11
        Position = 0;
        findRandom = true;
        delay(500);
        for (byte i = 0; i < NUM_LEDS; i++) {
